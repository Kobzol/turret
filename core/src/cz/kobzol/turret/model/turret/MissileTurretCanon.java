 ...
 */
public class MissileTurretCanon extends TurretCanon {
    ...
    protected class Bullet extends SpriteObject {
        ...
        private final MissileTurretCanon canon;
        private final IDamager iDamager;

        public Bullet(float damage, MissileTurretCanon canon, float speed, IDamager iDamager) {
            this.canon = canon;
            this.damage = damage;
    ...
    public MissileTurretCanon(float range, float damage, long fireDelay, float bulletSpeed, IDamager iDamager) {
    ...
    private void rotateCanon(float delta) {
        float canon_rotation = MissileTurretCanon.CANON_ROTATION * delta;
